...
export const CrearNotes = () => {
  ...
  const crearNotes = () => {
    ...
    dispatch(obtenerLaFechaDeOportunidadDeMejora({idPlanDeMejoramiento,year:start}));

      dispatch(crearNotas({titulosDeNotas,bodyDeNotas,idPrograma
        ,idPlanDeMejoramiento,idOportunidadDeMejora,idActividadesDeMejora,
        idProyeccionDeEventos,files:arraysFiles,start,mes,dia}))
