...
import { vaciarActividadeDeMejora } from '../../../store/programas/oportunidadDeMejoraSlice';
...
export const OportunidadDeMejora = () => {
    ...
    const setOportunidades = (event) => {
      navigate(`/homepage/${idPrograma}/${idPlanDeMejoramiento}/${event}/actividades`);
    ...
    const editarOportunidadDeMejora = () => {
      ...
      navigate(`/homepage/${idPlanDeMejoramiento}/${idPrograma}/edit`)
  ...
  return (
    ...
    <div className="d-flex flex-row-reverse">
            <button className="btn btn-outline-danger ms-5 mt-3 me-5" type="button"
              ...
              onClick={editarOportunidadDeMejora}
            >
      ...
      <ul >
        {
          ...
          <li className={`${(active.calidadDeContenido === 'Denominacion') ? 'mb-1' : 'd-none'}`} >
              ...
              <button className="btn mb-2 listas-cuadrado text-light" onClick={() => setOportunidades(active._id)}> 
  ...
  <div className={`accordion-item ${(InfraestructuraFísica === 0) ? 'd-none' : ''}`}>
    ...
    <div id="collapse8" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
      ...
      <ul >
        ...
        <Link to={`/homepage/${idPrograma}/${idPlanDeMejoramiento}/selectCondicionesDeCalidad`}>
