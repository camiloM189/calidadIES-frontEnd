...
import { AgregarUsuarioAUniversidad } from '../universidad/AgregarUsuarioAUniversidad';

export const ProgramaPage = () => {
    const dispatch = useDispatch();
  const { programas } = useSelector(state => state.planDeMejoramiento);
  const {idUniversidad} = useSelector(state => state.auth);
