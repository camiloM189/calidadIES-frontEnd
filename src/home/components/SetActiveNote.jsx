...
export const SetActiveNote = () => {
  ...
  const { name,pagina, _id, id } = useParams();
  ...
  const update = () => {
     ...
     if(title !== undefined && body !== undefined){
       dispatch(updateNotes({pagina, _id, id, noteId , title, body,arraysFiles}));
     }else if(title !== undefined){
       dispatch(updateNotes({pagina, _id, id, noteId ,title, 
         body:trueNote[0].body,arraysFiles}));
     }else if(body !== undefined){
       dispatch(updateNotes({pagina, _id, id, noteId ,
         title:trueNote[0].noteTitle,body,arraysFiles}));
  
       }else{
       dispatch(updateNotes({pagina, _id, id, noteId ,
         title:trueNote[0].noteTitle, body:trueNote[0].body,arraysFiles}));
     }
  ...
  return (
    <>
      <div className="container  windowNotes">
        <h2 className="text-dark mt-2">Fecha: {`${trueNote[0].dia}/${trueNote[0].mes}/${trueNote[0].año}`}</h2>
        <div className="mb-3">
